    ...
    <section className="py-24 overflow-x-clip">
      <div className="container mx-auto px-4 relative">
        ...
        <p className="text-center text-xl text-white/50 mt-8 max-w-2xl">
          ...
          features with an intuitive that keeps you in your creative flow.
        </p>
        <form
          action=""
        ...
        >
          ...
          />
          <button type="submit" className="border h-10 rounded-full px-6 font-medium bg-lime-400 text-neutral-950 border-lime-400 hidden md:inline-flex items-center whitespace-nowrap">Sign Up</button>
        </form>
      </div>
    </section>
  );
