        ...
        <div className="mt-8 flex flex-wrap gap-3 justify-center">
          {features.map((feature) => {
            return (
              <div
                key={feature}
                className="border-e-neutral-900 border border-white/10 inline-flex px-3 md:px-5 py-1.5 md:py-2 rounded-2xl gap-3 items-center hover:scale-105 transition duration-500 group"
              >
